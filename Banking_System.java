    ...
    public static void main(String aregs[]) 
    {
        ...
        while (true) 
        {
            ...
            if (DecisionOption == 2) 
            {
                ...
                while (Data[CustomerCount][4].matches("(0[1-9]|[1-2][0-9]|3[0-1])" + "/" + "(0[1-9]|1[1-2])"+ "/" + "(19[5-9][0-9]|200[0-9]|20[1-2][0-9])") == false) 
                {
                    System.out.println("WRONG INPUT PLEASE TRY AGAIN !! ");
                    System.out.print("DOB(dd/mm/yyyy)                                   : ");
                    Data[CustomerCount][4] = s.nextLine();
                ...
                if (AccountVerification == 1) 
                {
                    ...
                    switch (Option1) 
                    {
                        ...
                        case 1:
                            ...
                            String Date1 = s.next();
                            while(Date1.matches("(0[1-9]|[1-2][0-9]|3[0-1])" + "/" + "(0[1-9]|1[1-2])"+ "/" + "(200[0-9]|20[1-3][0-9])") == false)
                            {
                                System.out.println("WRONG INPUT PLEASE TRY AGAIN !! ");
